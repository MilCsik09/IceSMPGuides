...
1. **Kollektív célok népesség-vakok.** 8 fős szerveren: WIN_RAID×20 cél ≈ 10+ hét (a
   ...
   kézi újrahangolás kis szerverre.
...
6. Onboarding-lánc zsákutca: az onboarding_gather-nek nincs next-je → a kaszt-próbát
   magától kell megtalálni. [GYORS] • Csak 4/13 kaszt kapott teljes mentor-láncot.
...
9. HolidayService override() halott hook (0 hívó) — az ünnepeknek nincs mechanikai
   hatása. [GYORS: vérhold/invázió ünnep-skin bekötése]
...
11. DARK-belépés newbie-trap (ingyenes, prompt nélkül, "örök"); Mortengrad (a scope:
    capital feltételezte főváros) még nem létezik → addig scope: all ajánlott. [GYORS]
...
13. Szakma-heti célok: a craft-szakmáknak (armorer 333 smith/hét, cook 1000 étel) 3-5×
    nehezebb egység-áron, mint a gyűjtőknek. [GYORS: célszám-hangolás]
14. Rontás-loot gyengébb, mint a kincsláda, pedig nagyobb munka. [GYORS] • Csoportos
    tartalom kasszába fizet (hígul), a szóló-események zsebbe — a racionális játék a
    szóló-farm. → world-boss személyes bónusz-tétel.

## 🟢 Polish / doc

15. 17 riddle-quest él, a doc 16-ot mond. [GYORS] • Dungeon-rendszer kapu-kód létezik,
