...
- **A17** Teljes HP-rendszer átdolgozása — ✅ 1. ÜTEM KÉSZ (kaszt-HP-profilok + healthScale-normalizálás + harcon kívüli regen + gyógyítás-skálázás; a sebzés-oldal a nagyobb tavakkal RELATÍVE hangolódott). NYITVA: pajzs-egységesítés (abszorpció-források közös szabálya) + playtest-alapú finomhangolás (PvP TTK, PvE mob-damage). 🟡⭐⭐⭐
