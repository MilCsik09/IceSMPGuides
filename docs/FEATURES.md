...
- **Prezentáció:** alapból a story címe/típusa/nézőpontja chatben marad meg, az aktuális beat action baron fut. A négy presentation flag (`title-chat`, `title-actionbar`, `beat-chat`, `beat-actionbar`) reloadolható, ezért accessibility vagy tesztelés miatt a beat chatre is visszakapcsolható.
