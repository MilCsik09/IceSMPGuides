...
### 5.6. Tábortűzi mesélőhely

A story trigger továbbra is pontosan ezt a top-down geometriát kéri, egy főirányban:

`ülőblokk → 1 üres blokk → égő CAMPFIRE vagy SOUL_CAMPFIRE`.

A v2 rendszerben **a campfire a session közös horgonya**, nem a játékos. Ezért egy jó
mesélőhelyhez érdemes ugyanazt a tüzet több külön ülőblokkból elérhetővé tenni, úgy,
hogy minden szék és a tűz között megmaradjon az egyetlen üres blokk. Az ugyanahhoz a
tűzhöz leült játékosok ugyanazt a mesét hallják; nem kell minden székhez külön campfire.

Builder-átadáskor legalább ezt próbáld:

- két-négy játékos külön ülőblokkon ugyanahhoz a tűzhöz ül le a gyülekezési idő alatt;
- egy játékos a történet közben ül le, és a következő beattől ugyanahhoz a sessionhöz csatlakozik;
- egyik hallgató feláll: csak ő essen ki, a többiek története folytatódjon;
- a tűz kialszik: a session ne folytassa a mesét;
- a köztes üres blokk megszűnik: az érintett ülőhely többé ne számítson hallgatónak;
- a session végén ugyanaz a konkrét tűz a beállított rövid anti-spam időn belül ne indítson új mesét.

A történetszöveg nem builder-authority: a kánon és a perspektívák a
`content/lore/campfire-stories.yml` fájlban élnek. A builder feladata a hiteles,
kényelmes és többjátékos használatra alkalmas mesélőhely.
