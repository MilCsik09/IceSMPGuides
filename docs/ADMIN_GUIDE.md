...
| [ ] | SIT-25 Campfire achievement lánc | Tesztelő/admin | külön profilokkal teljesíts 1/10/50 storyt, minden alaptörténetet legalább egyszer, egy story öt perspektíváját, végül a teljes aktuális 135×5 collectiont | a hat prestige achievement egyszer oldódik fel és megjelenik az `/achievements` GUI-ban; nincs erő-/valutajutalom; későbbi teszt-story hozzáadása nem vonja vissza a már megszerzett badge-et | achievement/profile backup, rollout stop | `sit/SIT-25/` |
...
| [ ] | SIT-27 Krónikák collection GUI | Tesztelő | `/achievements → Krónikák`; profilon legyen 0, részleges és 5/5 perspektívás story; lapozz végig mind a 4 oldalon | ismert story címe + `Krónika`/`Szájhagyomány` típus + perspektíva-checkek látszanak, teljes story kiemelt; ismeretlen entry csak `Ismeretlen történet #N`, title/lore/típus spoiler nélkül; lapozás és visszaút működik; GUI ugyanazt a startup-katalógust használja, nincs újraparszolás | GUI rollout stop, profil változatlan | `sit/SIT-27/` |
