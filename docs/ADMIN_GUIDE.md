...
| [ ] | SIT-26 Katalógus és prologue ceiling | Admin/tesztelő | restart után ellenőrizd a `content/lore/campfire-stories.yml` betöltését Season 0-ban és utána | 135 story / 675 variáns betölt; minden story öt perspektívás; `available-during-prologue: false` entry nem választható Season 0-ban, `ket_mondat` továbbra is tiltott | content rollback, rollout stop | `sit/SIT-26/` |
