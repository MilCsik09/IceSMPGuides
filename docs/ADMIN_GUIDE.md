...
| [ ] | SIT-28 Story prezentáció | 2–3 tesztelő | default presentation configgal indíts közös sessiont, majd próbáld külön a négy presentation flag kombinációit reload után | defaulton a cím/típus/nézőpont egyszer chatbe kerül, az aktuális beat action baron fut; a beat nem spammeli a chatet; late joiner megkapja a címet és a következő beatet; `beat-chat: true` és `title-actionbar: true` külön működik | presentation flag rollback + reload | `sit/SIT-28/` |
